...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, in.thedevguys.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, in.thedevguys.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, in.thedevguys.domain.User.class.getName());
            createCache(cm, in.thedevguys.domain.User.class.getName() + ".comments");
            createCache(cm, in.thedevguys.domain.User.class.getName() + ".projectsOwneds");
            createCache(cm, in.thedevguys.domain.User.class.getName() + ".todosCreateds");
            createCache(cm, in.thedevguys.domain.User.class.getName() + ".notifications");
            createCache(cm, in.thedevguys.domain.User.class.getName() + ".attachments");
            createCache(cm, in.thedevguys.domain.User.class.getName() + ".assignedTodos");
            createCache(cm, in.thedevguys.domain.User.class.getName() + ".badges");
            createCache(cm, in.thedevguys.domain.User.class.getName() + ".projectMembers");
