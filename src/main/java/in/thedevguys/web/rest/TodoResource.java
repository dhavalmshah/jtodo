...
/**
 * REST controller for managing {@link in.thedevguys.domain.Todo}.
 */
@RestController
...
public class TodoResource {
    ...
    public ResponseEntity<TodoDTO> createTodo(@Valid @RequestBody TodoDTO todoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/todos/" + todoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, todoDTO.getId().toString()))
            .body(todoDTO);
    }
