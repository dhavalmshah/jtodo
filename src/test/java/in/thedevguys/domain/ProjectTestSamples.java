...
public class ProjectTestSamples {
    ...
    public static Project getProjectSample1() {
        return new Project().id(1L).name("name1").description("description1").color("color1").icon("icon1");
    }

    public static Project getProjectSample2() {
        return new Project().id(2L).name("name2").description("description2").color("color2").icon("icon2");
    }
