...
import static in.thedevguys.domain.CommentAsserts.*;
...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        return new Comment().content(DEFAULT_CONTENT).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT);
    }
    ...
    public static Comment createUpdatedEntity() {
        return new Comment().content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
