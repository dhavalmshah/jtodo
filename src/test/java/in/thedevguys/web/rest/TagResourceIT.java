...
import static in.thedevguys.domain.TagAsserts.*;
...
class TagResourceIT {
    ...
    public static Tag createEntity() {
        return new Tag().name(DEFAULT_NAME).color(DEFAULT_COLOR).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT);
    }
    ...
    public static Tag createUpdatedEntity() {
        return new Tag().name(UPDATED_NAME).color(UPDATED_COLOR).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).color(UPDATED_COLOR).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.color(UPDATED_COLOR);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).color(UPDATED_COLOR).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
