...
import static in.thedevguys.domain.ProjectAsserts.*;
...
import in.thedevguys.repository.ProjectRepository;
import in.thedevguys.service.dto.ProjectDTO;
import in.thedevguys.service.mapper.ProjectMapper;
...
class ProjectResourceIT {
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).updatedAt(UPDATED_UPDATED_AT).icon(UPDATED_ICON);
